...
FROM quay.io/alfresco/alfresco-base-java:9.0.1-oracle-centos-7-fbb3743bb757
...
RUN yum install -y apr apr-devel apr-util apr-util-devel openssl-$OPENSSL_VERSION openssl-devel-$OPENSSL_VERSION \
